"""
from: https://github.com/karpathy/arxiv-sanity-preserver/blob/master/fetch_papers.py
...
if __name__ == "__main__":
  ...
  parser.add_argument('--db-path', type=str, default="mini-arxiv.p", help='Path to the pickle dump of the papers')
